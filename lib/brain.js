...
class Brain {
  ...
  startStream() {
   this.raspivid = spawn('sh', ['-c',
      "raspivid -w 800 -h 500 -fps 10 -vf -hf -cd MJPEG -t 0 -o - | ffmpeg -loglevel panic -i - -f mpegts -codec:v mpeg1video -s 800x500 -b:v 750k https://robots.brainyant.eu:8080/"+this.streamParam],
      {detached: true});
  }
  stopStream(){
